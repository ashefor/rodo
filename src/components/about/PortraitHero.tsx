...
export function PortraitHero() {
  return (
    <section className="pt-28 md:pt-36 pb-16 md:pb-20 bg-foreground">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <h1 className="font-heading text-white text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6">
              We create timeless visual stories from{" "}
              <span className="text-primary">life’s most meaningful moments.</span>
            </h1>

            <p className="text-on-surface-dark-variant text-base md:text-lg leading-relaxed">
